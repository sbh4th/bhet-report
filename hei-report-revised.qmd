...
tt(m_table,
  ...
  notes = list("Note: ATT = Average Treatment Effect on the Treated, DiD = Difference-in-Differences.", 
     a = list(i=0, j=6,
     text = "Extended two-way fixed effects models for air pollution outcomes were adjusted for household size, smoking, outdoor temperature, and outdoor humidity. Temperature models not additionally adjusted."))) %>%
  group_tt(
    j = list("DiD" = 4:5, 
             "Adjusted DiD" = 6:7),
