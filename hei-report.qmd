...
```{r mi-plots, echo=FALSE, out.width = "80%"}
#| label: fig-flowchart
#| fig-cap: "Kernal density plots showing distribution of multiply-imputed values for BMI, Waist circumference, and indoor PM~2.5~ (red lines) and observed values (heavy black line)"
```
![BMI]("images/MI_BMI_density.png")
