...
What about this table? (@tbl-fuel-did)
```{r}
#| echo: FALSE
#| label: tbl-fuel-did
...
models_coal_note <- paste("Joint test that all cohort-time ATTs are equal: ", 
    "F(", models_coal$ht1$df1, ", ", 
    models_coal$ht1$df2, ")= " , 
    round(models_coal$ht1$statistic, digits=3), ", p= ", 
    round(models_coal$ht1$p.value, digits=3), sep="")

models_bio_note <- paste("Joint test that all cohort-time ATTs are equal: ", 
...
tt(fuel_table,
  ...
  style_tt(i = 7, line = "b", line_color = "black") %>%
  format_tt(escape = TRUE)
  #%>%
  #style_tt(
  #  i = c(2, 4, 6, 8), j = 1, 
