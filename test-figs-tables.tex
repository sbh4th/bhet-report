...
\caption{\label{tbl-pmf}\textbf{?(caption)}}\begin{minipage}[t]{\linewidth}
\subcaption{\label{tbl-pmf-1}}
...
-- Column specification --------------------------------------------------------
Delimiter: ","
chr (14): category, type, time, substance, measure, metric, Mean_S1, GM_S1, ...
