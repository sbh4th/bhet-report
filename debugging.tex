...
What about this table? (Table~\ref{tbl-fuel-did})
...
note{a}={Joint test that all cohort-time ATTs are equal: F(3, 2886)= 1.856, p= 0.135},
note{b}={Joint test that all cohort-time ATTs are equal: F(3, 2886)= 5.545, p= 0.001},
]                     %% tabularray outer close
{                     %% tabularray inner open
colspec={Q[]Q[]Q[]Q[]Q[]Q[]},
