...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, interior hidden, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, frame hidden, enhanced]}{\end{tcolorbox}}\fi
...
As noted in the methods section\ldots Table \textbf{?@tbl-a-het-pm}
shows\ldots{}

\begin{table}

\caption{\label{tbl-a-het-ppm}\textbf{?(caption)}}\begin{minipage}[t]{\linewidth}
\subcaption{\label{tbl-a-het-ppm-1}}
...
PMF error estimation diagnostics.
