...
3. Quantify the contribution of changes in the chemical composition of PM~2.5~ from different sources to the overall effect on health outcomes (Previously Aim 2).
...
```{r fig-map, echo=FALSE, out.width = "80%"}
#| label: fig-map
...
@fig-flowchart shows the participation across waves of data collection. 
