...
t1f <- tt(t1@table_dataframe) %>%
  ...
  style_tt(i = c(1,11,28), bold=TRUE) %>%
...
### Impact of policy on potential mediators (air pollution and indoor temperature)
...
### Impact of the CHP on health outcomes
