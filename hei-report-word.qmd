...
```{r fig-map, echo=FALSE, out.width = "70%", eval=T}
#| label: fig-cbhp-map
...
```{r tab-pm-sample, echo=F, message=F, warning=F, eval=T}
#| label: tbl-pm-sample
...
```{r tbl-each-campaigns, echo=F, eval=F}
...
```{r tbl-diff-campaign, echo=F, eval=F}
