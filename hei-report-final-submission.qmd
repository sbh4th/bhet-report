...
Our comparison of self-reported versus actual winter electricity bills in a subsample of households (n=37) with an available electricity bill showed that both untreated and treated households incorrectly reported their winter electricity expenses, but treated households were particularly prone to underestimating electricity use compared with untreated households. This tendency suggests that our calculations of the average treatment effects on winter energy use might be conservative, acting as a lower-bound estimate rather than an overestimation (figure S???).
