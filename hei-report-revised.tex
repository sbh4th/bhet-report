...
(\textbf{?@tbl-each-campaign}) or between participants in each of the
three waves with individual measurements (\textbf{?@tbl-diff-campaign}).

\begin{table}

\caption{\label{tbl-23-data}}
...
\caption{\label{tbl-table1}Descriptive statistics for selected
