...
ctab1 <- tibble(
  ...
  `Wave 1 (2018-19) N=1003` = c("580 (57.8)",
    "257 (25.6)", "788 (78.6)", "60.7 (9.2)",
    "26.1 (3.7)", "86.8 (10.2)"),
  `Wave 2 (2019-20) N=1110` = c("653 (58.8)", 
    "295 (26.6)", "897 (80.8)", "61.4 (9.1)",
    "25.7 (3.5)", "87.4 (9.4)"),
  `Wave 4 (2021-22) N=1028` = c("612 (59.5)",
...
ctab2 <- tibble(
  `Characteristic` = c("Female, n (\\%)", 
    ...
    "BMI in kg/m\\textsuperscript{2}, Mean (SD)", 
    "Waist circumference in cm, Mean (SD)"),
  `1 Wave N=365` = c("211 (57.8)", 
    "110 (30.1)", "288 (78.9)", "59.9 (9.2)",
    "26.3 (3.6)", "90.3 (9.8)"),
  `2 Waves N=443` = c("253 (57.1)",
    "117 (26.4)", "360 (81.3)", "60.5 (8.8)",
    "25.8 (3.5)", "86.5 (10)"),
  `3 Waves N=630` = c("370 (58.7)",
...
```{r tbl-resp-med, echo=F, message=F, warning=F}
#| label: tbl-resp-med
...
kable(cde_resp, digits = 2,
  ...
  add_header_above(c(" " = 1, 
    ...
    escape = F) %>%
    footnote(
    general = "\\\\small{Note: ATT = Average Treatment Effect on the Treated, CDE = Controlled Direct Effect.}",
...
## Pre-trends for blood pressure

```{r pretw3-plots, echo=FALSE, out.width="50%"}
#| fig-cap-location: top
#| label: fig-afig-pt3
...
```{r pretw4-plots, echo=FALSE, out.width = "40%"}
#| fig-cap-location: top
#| label: fig-afig-pt4
#| fig-cap: "Comparison of pre-interventions trends in blood pressure between waves 1 and 2 for never treated and villages later treated in wave 4"
#| fig-subcap: 
...
modelsummary(list("Adjusted DiD" = pe_etwfe_me, 
  ...
  notes = c("Note: All models adjusted for household size, smoking, outdoor temperature, and outdoor humidity.", 
