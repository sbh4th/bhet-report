...
```{r tab-diff-campaign, echo=F, eval=T, tab.cap="Demographic and health characteristics of participants in each study wave."}
...
t1 <- datasummary_balance(~et, data = dt, 
  ...
  title = "Descriptive statistics for selected demographic, health, and environmental measures at baseline, by treatment status.")
t1 %>%
...
```{r tbl-pm-season, echo=F, message = F, warnings = F, eval=F}
#| label: tbl-pm-season
...
```{r tab-did-med, echo=F, message=F, warning=F, eval=F}
#| label: tbl-did-med
...
```{r tbl-did-bp, echo=F, message=F, warning=F, eval=F}
...
```{r tbl-bp-med, echo=F, message=F, warning=F, eval=F}
#| label: tbl-bp-med
...
```{r tbl-resp-med, echo=F, message=F, warning=F, eval=F}
#| label: tbl-resp-med
...
```{r tbl-source-error, echo=F, message=F, warning=F, eval=F}
#| label: tbl-pmf
...
```{r source-did, echo=F, message=F, warning=F, eval=F}
...
```{r tbl-med-source, echo=F, message=F, warning=F, eval=F}
...
```{r atbl-fuel, echo=F, eval=T, eval=F}
#| label: tbl-fuel-did
...
```{r atbl-het-temp, echo = F, message = F, eval=F}
...
```{r atbl-bp-het, echo=F, message=F, eval=F}
#| label: tbl-bp-het
...
```{r atbl-bp-het-med, echo=F, message=F, eval=F}
...
```{r atbl-bp-het-med-tests, echo=F, message=F, eval=F}
...
```{r atbl-het-cough, echo=F, eval=F}
...
```{r atbl-het-phlegm, echo=F, eval=F}
...
```{r atbl-het-wheeze, echo=F, eval=F}
...
```{r atbl-het-breath, echo=F, eval=F}
...
```{r atbl-feno, echo=F, message = FALSE, eval=F}
#| label: tbl-a-feno
