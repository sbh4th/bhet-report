...
\subcaption{\label{fig-mi-3}}
\end{minipage}%

\caption{\label{fig-mi}Kernal density plots showing distribution of
multiply-imputed values for BMI, waist circumference (cm), and indoor
PM\textsubscript{2.5} (µg/m\textsuperscript{3}) (red lines) and observed
values (heavy black line)}
