...
\textbf{?@tbl-a-bp-med-het} shows the cohort-time treatment effects for
the mediation model for blood pressure.

\begin{table}[H]

\caption{\label{tbl-a-ind-s3}Effects of the CHP policy on outdoor 24-hr
and seasonal PM\textsubscript{2.5} based on whether Season 3 data are
