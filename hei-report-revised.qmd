...
d <- read_csv(here("data-clean", 
  ...
  col_select = c("hh_id", "ptc_id", "gender_health",
    ...
    "BCconc_exposureugm3", "PM25_exp_remove",
    "BC_exp_remove"))
...
We also ran disaggregated analyses for personal and outdoor samples separately (details in the Appendix). We found some differences in the number of factors and source attributions, but the core findings remained largely consistent with the pooled results. For the personal exposure samples (Appendix @fig-pmf-personal and Appendix @tbl-pmf-personal), the 3-factor solution identified dust, transported dust, and mixed combustion (a combination of biomass burning and secondary PM), while the 5-factor solution further split the mixed combustion factor into distinct coal combustion and sulfur secondary factors. Similarly, for the outdoor PM samples (Appendix @fig-pmf-outdoor, and Appendix @tbl-pmf-outdoor), the 3-factor solution identified mixed combustion, secondary PM, and dust, while the 5-factor solution introduced transported dust and a refined characterization of secondary species contributions. Despite these differences in the disaggregated analysis, the primary sources of pollution--dust, secondary sulfur, and mixed combustion--were consistent across both the pooled and separate analyses, demonstrating that the main findings are robust.
...
### Personal exposure sample analysis
For the personal exposure samples, @fig-pmf-personal shows results for the 3-, 4-, and 5-factor solutions, and @tbl-pmf-personal shows diagnostics for the PMF analysis. 
...
```{r, out.width = "90%"}
#| echo: FALSE
#| label: fig-pmf-personal
#| fig-cap-location: top
#| fig-cap: 3-, 4-, and 5- factor solutions for personal exposure samples.


knitr::include_graphics(here("outputs",
  "pmf-personal-3-factor.png"))
...
### Outdoor exposure sample analysis

For the outdoor exposure sample, @fig-pmf-outdoor shows results for the 3-, 4-, and 5-factor solutions, and @tbl-pmf-outdoor shows diagnostics for the PMF analysis for personal exposure samples.

```{r, out.width = "90%"}
#| echo: FALSE
#| label: fig-pmf-outdoor
#| fig-cap-location: top
#| fig-cap: 3-, 4-, and 5- factor solutions for outdoor exposure samples.


knitr::include_graphics(here("outputs",
  "pmf-outdoor-3-factor.png"))
...
tt(rp_table,
  ...
  a = list(i=0, j=7, text = "Assuming the true effect size and our study design and precision, the probability that an observed estimate will have the wrong sign."), 
  b = list(i=0, j=8, text = "Assuming the true effect size and our study design and precision, the ratio by which an observed estimate will exaggerate the true effect.")
  )) %>%
  group_tt(
