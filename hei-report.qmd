...
```{r master_data, include = FALSE, cache = TRUE}
# read in master data
...
@tbl-table_resp shows the impacts on respiratory outcomes. 
...
#| label: tbl-atable1
#| tbl-cap: "Trends in self-reported coal and biomass"
knitr::include_graphics(here("images", "coal-plot.png"))
```

@tbl-atable1 shows...

Compare with Figure \\ref{tbl-atable1}
