...
### Personal exposure 
As noted in the methods section...Table @tbl-a-het-personal shows...

```{r atbl-het, echo=F}
#| label: tbl-a-het-personal
#| tbl-cap: "Heterogenous treatment effects"


options("modelsummary_format_numeric_latex" = "plain")
m_p <- read_rds(here("outputs", "m_ppm.rds"))
d_personal <- read_rds(here("data-clean", "d_personal.rds"))

mstest <- slopes(m_p$e1, newdata = subset(d_personal, treat==1), variables = "treat", by = c("cohort_year", "year"))
