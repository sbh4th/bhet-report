...
As noted in the methods section\ldots Table Table~\ref{tbl-a-het-ppm}
shows\ldots{}

\hypertarget{tbl-a-het-ppm}{}
\begin{table}
\caption{\label{tbl-a-het-ppm}Heterogenous treatment effects }\tabularnewline
